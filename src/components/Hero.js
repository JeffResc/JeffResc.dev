  ...
  return (
    <section>
      <div className="container mx-auto flex flex-col items-center px-4 py-8 text-center">
        <StaticImage src="../images/hero_profile.jpg" alt="Profile" className="object-scale-down h-56 w-56 mb-4 rounded-lg betterhover:hover:scale-110 duration-200" placeholder="blurred" loading="eager" />
