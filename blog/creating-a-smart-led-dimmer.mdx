...
# Introduction
I frequently see [very cheap battery-operated monochrome string lights](https://www.walmart.com/ip/859641125) on clearance at stores locally such as Walmart. I wanted to be able to take advantage of these deals, but most of the lighting equipment that I own is "smart" and tied into the [Home Assistant](https://home-assistant.io/) home automation system. I wanted to be able to bring these lights into my home automation system to control them more easily and tie them into my automations. There is the [QuinLED controller](https://quinled.info/), but it was a little overkill for these types of cheap monochrome string lights.
